        ...
        <div class="row ">
            <div class="col-lg-4">
                <a class="navbar-brand logo text-uppercase" href="index-1.html">
                    <img src="<?= Yii::$app->urlManagerFrontend->createUrl('/landing/images/logo-footer.png') ?>"
                         class="logo-light" alt="" height="30">
                    <!-- <img src="images/logo-dark.png" class="logo-dark" alt="" height="28"> -->
                </a>
                <p class="text-white-50 mt-2 mb-0">Kampus Institut Teknologi Sains dan Kesehatan PKU Muhammadiyah
                    Surakarta.</p>

                <div class="footer-icon mt-4">
                    <div class=" d-flex align-items-center">
                        <a href="https://www.youtube.com/user/STIKESPKU" class="me-2 avatar-sm text-center"
                           data-bs-toggle="tooltip"
                           data-bs-placement="top" title="YouTube ITS PKU">
                            <i class="mdi mdi-youtube f-24 align-middle text-primary"></i>
                        </a>
                        <a href="https://www.facebook.com/humasstikespku/" class="mx-2 avatar-sm text-center"
                           data-bs-toggle="tooltip"
                           data-bs-placement="top" title="Facebook ITS PKU">
                            <i class="mdi mdi-facebook f-24 align-middle text-primary"></i>
                        </a>
                        <a href="https://www.instagram.com/itspkumuhsurakarta/" class="mx-2 avatar-sm text-center"
                           data-bs-toggle="tooltip"
                           data-bs-placement="top" title="Instagram ITS PKU">
...
<section class="bottom-footer py-4 bg-dark">
    <div class="container">
